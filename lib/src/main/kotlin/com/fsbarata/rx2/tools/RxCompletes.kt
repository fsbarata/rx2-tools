...
fun <T> Single<T>.repeatWith(transformation: (Any) -> Single<Any>) = repeatWhen { it.flatMapSingle(transformation) }
fun <T> Maybe<T>.repeatWith(transformation: (Any) -> Single<Any>) = repeatWhen { it.flatMapSingle(transformation) }
fun Completable.repeatWith(transformation: (Any) -> Single<Any>) = repeatWhen { it.flatMapSingle(transformation) }
